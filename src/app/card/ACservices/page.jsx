  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-semibold">Appliance Service & Repair</h2>
        <Link href="/services/appliances" className="text-sm px-4 py-3 rounded text-blue-600 border border-gray-200 hover:underline">
          See all
        </Link>
      </div>
      ...
      <div className="flex overflow-x-auto gap-4 scrollbar-hide scroll-smooth">
        {services.map((service, idx) => (
          <div
            key={idx}
            className="w-[240px] h-[220px] bg-gray-200 rounded-2xl shadow-md p-4 flex-shrink-0 text-center hover:shadow-lg transition-shadow duration-300"
          >
